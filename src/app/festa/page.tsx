...
export default function FestaPage() {
  return (
    <>
      ...
      <section className="bg-background px-6 py-10 md:py-12 lg:px-10">
      ...
      <div className="px-6 pb-20 lg:px-10 lg:pb-28">
        <div className="container-wide mx-auto max-w-3xl space-y-10">
          ...
          <article className="rounded-3xl border border-border bg-surface p-8 shadow-sm md:p-10">
            ...
            <dl className="mt-6 space-y-3 text-base text-foreground/80">
              ...
              <div>
                <dt className="inline font-medium text-foreground">Local: </dt>
