        ...
        <div className="container-wide mx-auto max-w-3xl">
          <ScrollReveal>
            <section className="mb-12">
              <h2 className="mb-6 font-display normal-case text-2xl text-foreground">Horários de missas</h2>
              <ul className="space-y-4">
                {massSchedules.map((entry) => (
                  <li key={entry.day} className="border-b border-border pb-4 last:border-0">
          ...
          <ScrollReveal>
            <section className="mb-12 border-t border-border pt-12">
              <h2 className="mb-6 font-display normal-case text-2xl text-foreground">Confissões</h2>
              <ul className="space-y-3">
                {confessionSchedules.map((entry) => (
                  <li key={entry.day}>
                    <span className="font-semibold">{entry.day}:</span>{" "}
                    <span className="text-muted">{entry.times.join(" · ")}</span>
                  </li>
                ))}
              </ul>
            </section>
          ...
          <ScrollReveal>
            <section className="mb-12 border-t border-border pt-12">
              ...
              <p className="mt-2 text-muted">{siteConfig.secretaryHours.saturday}</p>
            </section>
          </ScrollReveal>

          <ScrollReveal>
            <section className="border-t border-border pt-12">
              <h2 className="mb-6 font-display normal-case text-2xl text-foreground">Abertura da igreja</h2>
              <p className="text-muted">{siteConfig.churchHours.weekdays}</p>
              <p className="mt-2 text-muted">{siteConfig.churchHours.saturday}</p>
